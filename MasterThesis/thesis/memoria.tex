...
We can run the example within Eclipse embedded HTTP server or deploy it in our Apache server directly, the results is shown in figure below and there example can be accessed online in the following url of my blog:\\ \url{http://eparrillae.net/kudo/sencha/}
