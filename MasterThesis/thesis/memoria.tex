...
%
%http://altabel.wordpress.com/2012/12/14/mobile-web-app-frameworks-review-sencha-touch-vs-jquery-mobile/

%http://brianshim.com/webtricks/phonegap-and-jquery-mobile/


% failures of OpenBRR: old-fasioned metrics, failed to provide a "community-oriented" point of view, it was necessary to introduce new metrics
...
%http://try.sencha.com/
%
%Code contribution: http://try.sencha.com/submit/, see also: http://www.sencha.com/legal/terms-of-use/
%
%http://www.sencha.com/learn/sencha-touch-quick-start/
%
%http://docs.sencha.com/touch/2.2.1/#
%http://docs.sencha.com/touch/2.2.1/#!/guide/whats_new
%http://docs.sencha.com/touch/2.2.1/#!/example
%http://docs.sencha.com/touch/2.2.1/#!/video
%http://docs.sencha.com/touch/2.2.1/#!/guide
%http://docs.sencha.com/touch/2.2.1/#!/api
%
%
%http://docs.sencha.com/touch/2.2.1/#!/guide/apps_intro -> para MVC
%
%http://www.sencha.com/products/touch/download/
%
%http://www.sencha.com/products/touch/license/
%
%http://www.ibm.com/developerworks/library/wa-senchatouch/
%
%http://senchacon.com/
%
%http://en.wikipedia.org/wiki/Sass_(stylesheet_language) -> themes
%
%http://www.sencha.com/apps/ -> real world examples
%
%http://www.senchadevs.com/developers/search -> developers
